                    ...
                    <form action="{{ route('avaladores.update', $avalador) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="nombres" name="nombres"
                                value="{{ old('nombres', $avalador->nombres) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="apellido_paterno" name="apellido_paterno"
                                value="{{ old('apellido_paterno', $avalador->apellido_paterno) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="apellido_materno" name="apellido_materno"
                                value="{{ old('apellido_materno', $avalador->apellido_materno) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" id="telefono" name="telefono"
                                value="{{ old('telefono', $avalador->telefono) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="email" id="email" name="email"
                                value="{{ old('email', $avalador->email) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="direccion" name="direccion"
                                value="{{ old('direccion', $avalador->direccion) }}"
