    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          {{-- form edit --}}
          <form action="{{ route('residentes.update', $residente) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-6">
              ...
              <input type="text" id="ci" name="ci" value="{{ old('ci', $residente->ci) }}"
            ...
            <div class="mb-6">
              ...
              <input type="text" id="nombres" name="nombres" value="{{ old('nombres', $residente->nombres) }}"
            ...
            <div class="mb-6">
              ...
              <input type="text" id="apellido_paterno" name="apellido_paterno" value="{{ old('apellido_paterno', $residente->apellido_paterno) }}"
            ...
            <div class="mb-6">
              ...
              <input type="text" id="apellido_materno" name="apellido_materno" value="{{ old('apellido_materno', $residente->apellido_materno) }}"
            ...
            <div class="mb-6">
              ...
              <input type="number" id="edad" name="edad" value="{{ old('edad', $residente->edad) }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('edad') border-red-600  @enderror">
              @error('edad')
              <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
              @enderror
            </div>
            <div class="mb-6">
              ...
              <select id="sexo" name="sexo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                <option value="M" @selected($residente->sexo == "M")>Masculino</option>
                <option value="F" @selected($residente->sexo == "F")>Femenino</option>
              </select>
              @error('sexo')
              <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
              @enderror
            ...
            <div class="mb-6">
              <label for="nacionalidad" class="block mb-2 text-sm font-medium text-gray-900">
                {{ __('Pais de nacionalidad') }}
              </label>
              <input type="text" id="nacionalidad" name="nacionalidad" value="{{ old('nacionalidad', $residente->nacionalidad) }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('nacionalidad') border-red-600  @enderror">
              @error('nacionalidad')
              <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
              @enderror
            </div>
            <div class="mb-6">
              ...
              <input type="number" id="telefono" name="telefono" value="{{ old('telefono', $residente->telefono) }}"
            ...
            <div class="mb-6">
              ...
              <input type="email" id="email" name="email" value="{{ old('email', $residente->email) }}"
