<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
      {{ __('Editar Trabajador de reparación o mantenimiento') }}
    </h2>
  </x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          {{-- form edit --}}
          <form action="{{ route('trabajadores-de-rm.update', $trabajador_de_rm) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-6">
              ...
              <input type="text" id="ci" name="ci" value="{{ old('ci', $trabajador_de_rm->ci) }}"
            ...
            <div class="mb-6">
              ...
              <input type="text" id="nombres" name="nombres" value="{{ old('nombres', $trabajador_de_rm->nombres) }}"
            ...
            <div class="mb-6">
              ...
              <input type="text" id="apellido_paterno" name="apellido_paterno" value="{{ old('apellido_paterno', $trabajador_de_rm->apellido_paterno) }}"
            ...
            <div class="mb-6">
              ...
              <input type="text" id="apellido_materno" name="apellido_materno" value="{{ old('apellido_materno', $trabajador_de_rm->apellido_materno) }}"
            ...
            <div class="mb-6">
              ...
              <select id="sexo" name="sexo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                <option value="M" @selected($trabajador_de_rm->sexo == 'M')>Masculino</option>
                <option value="F" @selected($trabajador_de_rm->sexo == 'F')>Femenino</option>
              </select>
              @error('sexo')
              <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
              @enderror
            ...
            <div class="mb-6">
              ...
              <input type="text" id="direccion" name="direccion" value="{{ old('direccion', $trabajador_de_rm->direccion) }}"
            ...
            <div class="mb-6">
              ...
              <input type="number" id="telefono" name="telefono" value="{{ old('telefono', $trabajador_de_rm->telefono) }}"
            ...
            <div class="mb-6">
              ...
              <input type="email" id="email" name="email" value="{{ old('email', $trabajador_de_rm->email) }}"
            ...
            <div class="flex justify-between">
              ...
              <a href="{{ route('trabajadores-de-rm.index') }}">
                <span
