<x-app-layout>
  <x-slot name="header">
    <div class="flex align-items-center">
      ...
      <a href="{{ route('edificios.create') }}" class="ml-4 text-sm flex justify-center items-center max-sm:w-3/4" title="{{ __('Agregar un edificio') }}">
                  ...
                  <tr class="bg-white border-b">
                    ...
                    <td class="py-2 px-2 flex justify-between">
                      <a href="{{ route('edificios.edit', $edificio) }}">
                        <img src="{{ asset('img/edit-button.png') }}" alt="Editar edificio" class="h-auto w-6 md:w-6" title="{{ __('Edit') }}">
                      </a>
                      <form action="{{ route('edificios.destroy', $edificio) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit">
                          <img src="{{ asset('img/delete.png') }}" alt="Eliminar edificio" class="h-auto w-6 md:w-6 tbl-hapus" title="{{ __('Delete') }}">  
                        </button>
                      </form>
                    </td>
                  </tr>
