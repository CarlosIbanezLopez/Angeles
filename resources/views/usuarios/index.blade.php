<x-app-layout>
    <x-slot name="header">
        <div class="flex align-items-center">
            ...
            <a href="{{ route('usuarios.create') }}" class="ml-4 text-sm flex justify-center items-center max-sm:w-3/4"
                title="{{ __('Agregar un Usuario') }}">
                <img src="{{ asset('img/plus.png') }}" alt="Agregar un usuario" class="h-auto w-6 md:w-6">
            </a>
        </div>
    </x-slot>
                    ...
                    <div class="overflow-x-auto relative">
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr>
                                        <td colspan="5" class="text-center">Usuarios no existentes</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
