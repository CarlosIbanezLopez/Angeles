    ...
    <x-slot name="header">
        <div class="flex align-items-center">
            ...
            @can('admin.empleados.create')
                <a href="{{ route('empleados.create') }}" class="ml-4 text-sm flex justify-center items-center max-sm:w-3/4"
                    title="{{ __('Agregar un empleado') }}">
                                            ...
                                            <td class="py-2 px-2 flex justify-between">
                                                @can('admin.empleados.edit')
                                                    <a href="{{ route('empleados.edit', $empleado) }}">
                                                        <img src="{{ asset('img/edit-button.png') }}" alt="Editar empleado"
                                                    ...
                                                    <form action="{{ route('empleados.destroy', $empleado) }}"
                                                        ...
                                                        <button type="submit">
                                                            <img src="{{ asset('img/delete.png') }}"
                                                                alt="Eliminar empleado" class="h-auto w-6 md:w-6 tbl-hapus"
                                                                title="{{ __('Delete') }}">
                                                        </button>
                                                    </form>
                                                @endcan
